 ...
 */
public class ByteArraySwapable implements Swapable {

    public byte[] data;
    
    /**
     * <p>Crea un nuovo ByteArraySwapable</p>
     * 
     * 
     */
    public ByteArraySwapable(byte[] data) {
        super();
        this.data = data;
    }
