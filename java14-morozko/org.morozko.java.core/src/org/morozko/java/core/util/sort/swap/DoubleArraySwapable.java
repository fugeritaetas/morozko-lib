 ...
 */
public class DoubleArraySwapable implements Swapable {

    public double[] data;
    
    /**
     * <p>Crea un nuovo DoubleArraySwapable</p>
     * 
     * 
     */
    public DoubleArraySwapable(double[] data) {
        super();
        this.data = data;
    }
