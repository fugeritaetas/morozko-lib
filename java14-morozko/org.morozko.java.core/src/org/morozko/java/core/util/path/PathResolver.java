 ...
 * 
 * <p>Un altero può avere una struttura arbitraria, una istanza di PathResolver
 * server ad astrarre un percorso verso un nodo dell' albero, così da poterlo linearizzare.</p>
 * 
...
public interface PathResolver {
     ...
     *               <code>null</code> se path è la radice.
     */
     ...
     * @return      il nome del nodo (il nome della radice è la stringa vuota).
     */
    ...
    /**
     * <p>Verfifica la validità di un percorso all'interno del PathResolver.</p>
     * 
     * @param path  il percorso da validare
     * @return      <code>true</code> se il percorso è valido
     ...
     * 
     * @return      <code>true</code> se il percorso non è case sensitive
     *               <code>false</code> altrimenti
     */
    ...
    /**
     * <p>Verifica se un percorso è la radice del PathResolver.</p>
     * 
     * @param root  il percorso da verificare
     * @return      <code>true</code> se il percorso è la radice
     *               <code>false</code> altrimenti
     */
