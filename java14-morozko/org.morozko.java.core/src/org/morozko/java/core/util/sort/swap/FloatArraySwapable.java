 ...
 */
public class FloatArraySwapable implements Swapable {

    public float[] data;
    
    /**
     * <p>Crea un nuovo FloatArraySwapable</p>
     * 
     * 
     */
    public FloatArraySwapable(float[] data) {
        super();
        this.data = data;
    }
