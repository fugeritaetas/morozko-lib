 ...
 */
public class ShortArraySwapable implements Swapable {

    public short[] data;
    
    /**
     * <p>Crea un nuovo ShortArraySwapable</p>
     * 
     * 
     */
    public ShortArraySwapable(short[] data) {
        super();
        this.data = data;
    }
