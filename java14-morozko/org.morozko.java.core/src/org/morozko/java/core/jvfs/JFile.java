...
public interface JFile {
	 ...
	 * <p> 
	 *	<jdl:section>
	 * 		<jdl:text lang='it'>Se questo JFile è una directory restituisce un suo figlio di nome dato.</jdl:text>
	 ...
	 * <p> 
	 *	<jdl:section>
	 * 		<jdl:text lang='it'>Se questo JFile è una directory restituisce l'elenco dei nomi dei suoi figli.</jdl:text>
	 ...
	 * <p> 
	 *	<jdl:section>
	 * 		<jdl:text lang='it'>Se questo JFile è una directory restituisce l'elenco dei suoi figli.</jdl:text>
	 ...
	 * 
	 * @return	<jdl:section>
	 * 				<jdl:text lang='it'><code>true</code> se il path è una directory, <code>false</code> altrimenti.</jdl:text>
	 ...
	 * 
	 * @return	<jdl:section>
	 * 				<jdl:text lang='it'><code>true</code> se il path è un file, <code>false</code> altrimenti.</jdl:text>
	 ...
	 *						</jdl:section> 
	 * @return	<jdl:section>
	 * 				<jdl:text lang='it'><code>true</code> se la caratteristica è supportata, <code>false</code> altrimenti.</jdl:text>
	 ...
	 * <p> 
	 *	<jdl:section>
	 * 		<jdl:text lang='it'>Restituisce una data proprietà del file.</jdl:text>
	 * 		<jdl:text lang='en'>Return a given property of the file.</jdl:text>  
	 *	</jdl:section>
	 * </p> 
	 * 
	 * @param	propertyName	<jdl:section>
	 * 								<jdl:text lang='it'>Il nome della properietà.</jdl:text>
	 ...
	 * <p> 
	 *	<jdl:section>
	 * 		<jdl:text lang='it'>Verifica se si può leggere dal file.</jdl:text>
	 * 		<jdl:text lang='en'>Verify if you can read from file.</jdl:text>  
	 *	</jdl:section>
	 * </p> 
	 * 
	 * @return	<jdl:section>
	 * 				<jdl:text lang='it'><code>true</code> se il file può essere letto, <code>false</code> altrimenti.</jdl:text>
	 ...
	 * <p> 
	 *	<jdl:section>
	 * 		<jdl:text lang='it'>Verifica se si può scrivere sul file.</jdl:text>
	 * 		<jdl:text lang='en'>Verify if you can write on the file.</jdl:text>  
	 *	</jdl:section>
	 * </p> 
	 * 
	 * @return	<jdl:section>
	 * 				<jdl:text lang='it'><code>true</code> se il file può essere scritto, <code>false</code> altrimenti.</jdl:text>
