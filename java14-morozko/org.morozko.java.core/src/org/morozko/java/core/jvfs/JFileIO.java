...
import org.morozko.java.core.jvfs.fun.JFileFunResult;
import org.morozko.java.core.jvfs.fun.JFileFunSafe;
import org.morozko.java.core.jvfs.fun.ZipJFileFun;
   ...
   */
    ...
    */   	
    ...
    public static byte[] readBytes(JFile file) throws IOException {
        ...
        StreamIO.pipeStream(file.getInputStream(), dst);
    ...
    public static char[] readChars(JFile file) throws IOException {
        ...
        StreamIO.pipeChar(file.getReader(), dst);
	 ...
	 *							</jdl:section>
     */
    public int writeStringBuffer(StringBuffer data, String file ) throws IOException {
	 ...
	 *							</jdl:section>
     */
    public int writeString(String data, String file ) throws IOException {
	 ...
	 *							</jdl:section>
     */    
    public int writeBytes(byte[] data, String file ) throws IOException {
	 ...
	 *							</jdl:section>
     */
    public int writeChars(char[] data, String file ) throws IOException {
	 ...
	 *							</jdl:section>
     */    
    public static int writeStringBuffer(StringBuffer data, JFile file ) throws IOException {
	 ...
	 *							</jdl:section>
     */
    public static int writeString(String data, JFile file ) throws IOException {
	 ...
	 *							</jdl:section>
     */ 
    public static int writeBytes(byte[] data, JFile file ) throws IOException {
        return StreamIO.pipeStream(new ByteArrayInputStream(data), file.getOutputStream());
    }    
	 ...
	 *							</jdl:section>
     */
    public static int writeChars(char[] data, JFile file ) throws IOException {
        return StreamIO.pipeChar(new CharArrayReader(data), file.getWriter());
    }
