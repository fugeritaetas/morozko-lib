...
public class BinaryNumber {
	...
	public static final List LIST_BIN = Arrays.asList( convert( VALUES_BIN ) );
	public static final List LIST_OCT = Arrays.asList( convert( VALUES_OCT ) );
	public static final List LIST_HEX = Arrays.asList( convert( VALUES_HEX ) );
