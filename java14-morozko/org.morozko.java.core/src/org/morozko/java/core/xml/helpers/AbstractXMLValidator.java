 ...
 * @release		: xxxx.xx.xx
 */
package org.morozko.java.core.xml.helpers;
...
public abstract class AbstractXMLValidator implements XMLValidator {
    ...
    /* (non-Javadoc)
     * @see org.opinf.jlib.std.xml.XMLValidator#validateXML(java.io.Reader, org.morozko.java.core.xml.sax.SAXParseResult)
     */
    ...
    /* (non-Javadoc)
     * @see org.opinf.jlib.std.xml.XMLValidator#validateXML(java.io.InputStream, org.morozko.java.core.xml.sax.SAXParseResult)
     */
    ...
    /* (non-Javadoc)
     * @see org.opinf.jlib.std.xml.XMLValidator#validateXML(java.lang.StringBuffer, org.morozko.java.core.xml.sax.SAXParseResult)
     */
    ...
    /* (non-Javadoc)
     * @see org.opinf.jlib.std.xml.XMLValidator#validateXML(java.lang.String, org.morozko.java.core.xml.sax.SAXParseResult)
     */
    ...
    /* (non-Javadoc)
     * @see org.opinf.jlib.std.xml.XMLValidator#validateXML(byte[], org.morozko.java.core.xml.sax.SAXParseResult)
     */
    ...
    /* (non-Javadoc)
     * @see org.opinf.jlib.std.xml.XMLValidator#validateXML(char[], org.morozko.java.core.xml.sax.SAXParseResult)
     */
