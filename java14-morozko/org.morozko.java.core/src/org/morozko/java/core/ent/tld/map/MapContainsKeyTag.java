...
/**
 * <p>Tag che esegue il codice in esso contenuto solo se una mappa contiene un elemento con chiave data.</p>
 *
 *	<p>
 *		Ad esempio il seguente estratto di codice : <br/>
 *		<div class="codejsp"> 
 *			&lt;oimap:containsKey name='bean' keyName='chiave'&gt;<br/>
 *				&lt;oimap:write name='bean' keyName='chiave'/&gt;
 *			&lt;/oimap:containsKey name='bean' keyName='chiave'&gt;<br/>
 *		</div>
 *		<br/>
 *		<br/>
 ...
 *				&nbsp;&nbsp;&nbsp; out.print( mappa.get( pageContext.findAttribute( "chiave" ) ) );<br/>
 *				&nbsp;&nbsp; }<br/>
 *			%&gt;<br/>
 *		</div>
 *	</p>
 ...
 * @since JLIB-CORE 1.0
 */
public class MapContainsKeyTag extends MapTagHelper {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8985447405830613348L;
