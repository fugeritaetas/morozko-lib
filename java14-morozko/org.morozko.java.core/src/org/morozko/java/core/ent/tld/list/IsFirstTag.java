 ...
 *
 */
public class IsFirstTag extends ListTagHelper {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4337751607859211510L;
	...
	public int doStartTag() throws JspException {
		...
		boolean mainCheck = list.get( 0 ).equals( element );
		if ( notCheck ) {
			mainCheck = !mainCheck;
		}
		if ( !mainCheck ) {
