...
--	@package  : org.morozko.java.mod.app.cms.update.sql.oracle
--	@creation : 2006-08-25
...
CREATE TABLE cms_filter_chain ( 
	id_cms_filter_chain INTEGER NOT NULL, 
...
CREATE TABLE cms_filter_handler ( 
	id_cms_filter_handler INTEGER NOT NULL, 
...
ALTER TABLE cms_page ADD id_cms_filter_chain INTEGER;

ALTER TABLE cms_filter_handler ADD CONSTRAINT cms_filter_handler_fk1 FOREIGN KEY ( id_cms_filter_chain ) REFERENCES cms_filter_chain ( id_cms_filter_chain ) ON DELETE CASCADE;

ALTER TABLE cms_page ADD CONSTRAINT cms_page_fk2 FOREIGN KEY ( id_cms_filter_chain ) REFERENCES cms_filter_chain ( id_cms_filter_chain ) ON DELETE CASCADE;
