...
public class ConnectionFacadeWrapper implements ConnectionFactory {
	...
	/* (non-Javadoc)
	 * @see org.morozko.java.mod.db.connect.ConnectionFactoryImpl#getDataBaseInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see org.morozko.java.mod.db.connect.ConnectionFactoryImpl#release()
	 */
	...
	/* (non-Javadoc)
	 * @see org.morozko.java.mod.db.connect.ConnectionFactoryImpl#getConnection()
	 */
