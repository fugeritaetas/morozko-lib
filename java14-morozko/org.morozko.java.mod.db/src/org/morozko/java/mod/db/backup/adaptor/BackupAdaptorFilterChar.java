...
public class BackupAdaptorFilterChar extends DefaultBackupAdaptor {
	...
	/* (non-Javadoc)
	 * @see org.morozko.java.mod.db.backup.DefaultBackupAdaptor#get(java.sql.ResultSet, java.sql.ResultSetMetaData, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.morozko.java.mod.db.backup.DefaultBackupAdaptor#set(java.sql.PreparedStatement, java.sql.ResultSetMetaData, java.lang.Object, int)
	 */
