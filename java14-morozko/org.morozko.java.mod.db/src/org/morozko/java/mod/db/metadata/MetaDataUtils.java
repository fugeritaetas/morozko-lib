...
class DefaulJdbcdaptor extends BasicLogObject implements JdbcAdaptor {
	...
	/* (non-Javadoc)
	 * @see org.opinf.jlib.mod.tools.db.meta.JdbcCommentAdaptor#getColumnComment(org.morozko.java.mod.db.metadata.TableId, java.lang.String)
	 */
	public String getColumnComment(TableId tableId, String columnName) throws Exception {
		return "";
	}
	...
	/* (non-Javadoc)
	 * @see org.opinf.jlib.mod.tools.db.meta.JdbcCommentAdaptor#getTableComment(org.morozko.java.mod.db.metadata.TableId)
	 */
	public String getTableComment(TableId tableId) throws Exception {
		return "";
	}
	...
	public String getColumnExtraInfo(TableId tableId, String columnName) throws Exception {
		this.getLog().debug( "getColumnExtraInfo tableId    : "+tableId );
		this.getLog().debug( "getColumnExtraInfo columnName : "+columnName );
		return "";
	}
	...
	public String getColumnExtraInfo(TableId tableId, String columnName) throws Exception {
		...
		try {
			...
			if ( rs.next() ) {
				...
				this.getLog().debug( "getColumnExtraInfo extra : "+info );
			}
			rs.close();
			pstm.close();
		} catch (Exception e) {
...
class OracleJdbcAdaptor extends DefaulJdbcdaptor {
	...
	/* (non-Javadoc)
	 * @see org.opinf.jlib.mod.tools.db.meta.AbstractCommentAdaptor#getColumnComment(org.morozko.java.mod.db.metadata.TableId, java.lang.String)
	 */
	public String getColumnComment(TableId tableId, String columnName) throws Exception {
		String comment = "";
		Connection conn = this.getConnectionFactory().getConnection();
	...
	/* (non-Javadoc)
	 * @see org.opinf.jlib.mod.tools.db.meta.AbstractCommentAdaptor#getTableComment(org.morozko.java.mod.db.metadata.TableId)
	 */
	public String getTableComment(TableId tableId) throws Exception {
		String comment = "";
		Connection conn = this.getConnectionFactory().getConnection();
